...
- Projects Canada's average temperature to 2050 (linear regression R² ≈ 0.44)
...
| Metric | Value |
|--------|-------|
| Warming since 1960 | ~2.6°C |
| Projected temperature 2050 (linear) | ~-2.3°C |
| Radiative forcing range (1960–2024) | 7.8–10.4 W/m² |
| Regression R² | ~0.44 |
